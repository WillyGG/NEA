...
with tf.Session() as sess:
    ...
    while ep_num < num_train_ep:
        ...
        ep_history = []
        no_moves = 0
        game_state = blackjack.get_state()  # Returns num of cards in each players hand and hand value of each player
...
# TODO TEST THE NETWORK AFTER TRAINING AND FIX ALL THE BUGS